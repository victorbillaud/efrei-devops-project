def sendDiscordNotifer(message, footer) {
    ...
    def message_formated = "${message} ${currentBuild.currentResult} ${JOB_NAME} ${JOB_URL} ${BUILD_NUMBER}"
    discordSend description: message_formated, footer: footer, link: env.BUILD_URL, result: currentBuild.currentResult, title: JOB_NAME, webhookURL: "https://discord.com/api/webhooks/1130779978473152594/atG0OMY1qC-MH4MGW6maAnoRv9ZKBJR_CCjS9KcWdpyXrGm9EXjTdYg0lquV8kOpYh1W"
}
